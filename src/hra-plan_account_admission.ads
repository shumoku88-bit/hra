...
--  Pure Account-universe qualification of an already-admitted Plan graph.
--
...
package HRA.Plan_Account_Admission is
   ...
   function Graph_Of
     (Candidate : Account_Qualified_Graph)
      return HRA.Plan_Graph_Admission.Candidate_Graph;
...
private
   ...
   type Account_Qualified_Graph is record
      ...
      Graph_Value      : HRA.Plan_Graph_Admission.Candidate_Graph;
   end record;
