      ...
      Assert
        (HRA.Envelope_Commitment.Observe
           (Open_Plans,
            ...
            Commitment,
            Commit_Diag),
         "Observe Commitment from the same admitted temporal lifecycle result");
      Assert
        (HRA.Money.Lookup_Balance
